...
def bin_act_silu(args):
	...
	dst_tensor = torch.nn.functional.gelu(src_tensor)
	...
	print('GELU File: {} {} Format: {} Q: {} shape:{} '.format(args.i, args.o, args.f, args.q, data_dst.shape))

def init_param(args):
	parser = argparse.ArgumentParser(description="Compute GELU act function for binary file")
