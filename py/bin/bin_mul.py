...
def bin_mul(args):
	...
	data_dst = np.multiply(data_src1, data_src2)
	if (args.v):
	...
	print('Mul two files: {} * {} = {}; Format: {}; Q: {}; out.shape:{} '.format(args.i1, args.i2, args.o, args.f, args.q, data_dst.shape))

def init_param(args):
	parser = argparse.ArgumentParser(description="Compuate multiply for two binary file")
